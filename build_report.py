...
CSS = """
  ...
  *{box-sizing:border-box}
  ...
  h3{font-size:14.5px;margin:18px 0 4px;color:var(--ink2)}
  p{margin:8px 0}
  ...
  .chartttl{font-size:13px;font-weight:700;color:var(--ink2);margin:2px 0 8px 4px}
  .warn{background:var(--warnbg);border-left:4px solid var(--warnbd);border-radius:8px;padding:11px 14px;margin:12px 0;font-size:13px}
  .factor{margin:7px 0;font-size:14px}
  ...
  .foot{margin-top:30px;padding:16px 32px 26px;border-top:1px solid var(--line);color:var(--mute);font-size:12px;background:var(--card)}
